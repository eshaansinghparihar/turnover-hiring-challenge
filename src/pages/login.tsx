...
const LoginForm = () => {
  return (
    <div className="w-2/5 mx-auto border border-gray-300 rounded-xl p-8 mt-4">
      ...
      <button className="w-full bg-black text-white font-light tracking-widest text-xs px-6 py-4 rounded uppercase mt-6 mx-auto block hover:bg-gray-800">Login</button>
      <hr className="mt-6 mb-2 border-gray-400" />
    <div className="flex justify-center">
    <p className="text-xs mt-4 text-center text-gray-700">Don`t have an Account? <span className="font-light cursor-pointer uppercase tracking-widest hover:underline font-semibold">sign up</span></p>
    </div>
    </div>
  );
};
